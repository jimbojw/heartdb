 ...
 */
export function wrapWithFindPlugin<DocType extends Document>(
  pouchDb: PouchDB.Database<DocType>,
): PouchDB.Database<DocType> {
  ...
  const PouchDBWithFindPlugin = { ...PouchDBFindPlugin };
  ...
  return Object.create(PouchDBWithFindPlugin) as PouchDB.Database<DocType>;
}
